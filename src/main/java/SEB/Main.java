package SEB;
import SEB.RestHttp.RequestContext;
import SEB.RestHttp.RequestHandler;
...
public class Main {
    ...
    private static void handleRequest(Socket client) throws IOException{
        ...
        RequestHandler.pathsHandling(requestClient.getPath(),requestClient.getMethod(),requestClient.getPayload(),requestClient.getHeaders(),client);
